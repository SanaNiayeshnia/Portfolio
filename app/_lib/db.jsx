...
export const projectTechnologies = [
  ...
  { label: "Spotify-API", value: "Spotify-API" },
  { label: "PWA", value: "PWA" },
  ...
  { label: "Moment.js", value: "Moment.js" },
  ...
  { label: "Open-Library-API", value: "Open-Library-API" },
  { label: "Redux-Persist", value: "Redux-Persist" },
  ...
  { label: "Lottie", value: "Lottie" },
  {
    ...
    value: "React-Intersection-Observer",
  },
  { label: "Moment-Jalaali", value: "Moment-Jalaali" },
  { label: "React-Multi-Date-Picker", value: "React-Multi-Date-Picker" },
  { label: "Loadash", value: "Loadash" },
